...
const SideBar = () => {
  return (
    <div className="md:w-60 bg-indigo-400 h-screen flex-1 fixed border-r border-black hidden md:flex">
      <div className="flex flex-col space-y-6 w-full">
        ...
        <div className="flex flex-col space-y-2  md:px-6 text-black">
